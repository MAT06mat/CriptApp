...
class App():
    def __init__(self):
        ...
        self.Frame_page_gerer_2 = tk.Frame(self.app, bg=self.couleur['blanc'], pady=10)
    ...
    def ajouter_cle(self):
        ...
        button.config(command=button.copy)
        button.pack(side="top")
        self.mes_objets.append(button)
    ...
    def charger_fenetre(self):
        ...
        self.Frame_page_gerer_2.pack_forget()
        ...
        if self.page == "UTILISER UNE CLÉ":
            ...
            self.Entry_page_utiliser.delete(0, tk.END)
            global copy
...
class ButtonCopy(tk.Button):
    def copy(self, *args):
        global copy
        copy = self.cget("text")
        global app
        app.changer_page("UTILISER UNE CLÉ")
